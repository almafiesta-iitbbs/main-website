                        ...
                        switch (event.title) {
                          case "Offline MUN":
                            window.location.href =
                              "https://forms.gle/5ssWntR8MkFZtyzr5";
                            break;
                          case "Fashion Show":
                            window.location.href =
                              "https://docs.google.com/forms/d/e/1FAIpQLScbIKXAZkJ0RNlzGpHD320TwaA__mgmOuW--pvteonaMph9Gw/viewform";
                            break;
                          case "Escape Room":
                            window.location.href =
                              "https://forms.gle/QsNJVbMNMN3ChDHv6";
                            break;
                          case "Food fest":
                            window.location.href =
                          ...
                          case "Fantasy Quiz":
                            window.location.href =
                              "https://forms.gle/ACPXyMGBH2BtDwbk7";
                            break;
                          default:
