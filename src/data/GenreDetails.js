...
const dramatics = (
  <div>
    "The world's a stage and each one of us an actor. Alma Fiesta's the theatre
    that everyone is after" <br />
    <br />
...
const literature = (
  <div>
    ...
    <br />
    <br />
    Let your inner creativity out because Team Alma Fiesta brings to you
    exceptional events where you can let out your talent and skills and leave
    the people be astonished.
  </div>
);
...
const photography = (
  <div>
    ...
    tell the story of your imagination out of reality.
    <br />
    <br />
    So take out your cameras and steal some moments of your version of that
    perfection, since alma fiesta is here with a variety of interesting
    photography and cinematography events
  </div>
);
...
const finearts = (
  <div>
    ...
    other way - things I had no words for." <br />-<b>Georgia O'Keeffe</b>
    <br />
    <br />
    ...
    the eye perceives it to be. Keeping this in mind, Alma Fiesta'22 with the
    theme of a utopia presents fine art events from different mediums, calling
    every artist to express themselves with their creativity and imagination.
  </div>
);
...
const fashion = (
  <div>
    ...
    when human contacts are so quick. Fashion is instant language." <br />-
    <b>Miuccia Prada.</b>
    <br />
    <br />
    ...
    chance to exhibit your fashion aesthetics to the world.
  </div>
);
